	...
	function callbackSearch(data) {
	     ...
	     if (dataCnt > 0) {
	         ...
	         $.each(json, function(i, obj) {
	        	 element = new Array();
	             element[0] = ('<a style=\"text-decoration:none;\" href=\"javascript:viewBoothInfo(\''+ obj.boothDto.boothId + '\')\"><b>' + obj.boothDto.boothName + '</b></a>');
	             ...
	             element[8] = decode(obj.rateOfReturnQ1, '0.0','0',obj.rateOfReturnQ1);
	             element[9] = decode(obj.collectAmtQ1, '0.0','0',obj.collectAmtQ1);
	             element[10] = decode(obj.rentFeeAmtQ1, '0.0','0',obj.rentFeeAmtQ1);
	             element[11] = decode(obj.refundAmtQ1, '0.0','0',obj.refundAmtQ1);
                 ...
                 element[15] = decode(obj.rateOfReturnQ2, '0.0','0',obj.rateOfReturnQ2);
                 element[16] = decode(obj.collectAmtQ2, '0.0','0',obj.collectAmtQ2);
                 element[17] = decode(obj.rentFeeAmtQ2, '0.0','0',obj.rentFeeAmtQ2);
                 element[18] = decode(obj.refundAmtQ2, '0.0','0',obj.refundAmtQ2);
                 ...
                 element[22] = decode(obj.rateOfReturnQ3, '0.0','0',obj.rateOfReturnQ3);
                 element[23] = decode(obj.collectAmtQ3, '0.0','0',obj.collectAmtQ3);
                 element[24] = decode(obj.rentFeeAmtQ3, '0.0','0',obj.rentFeeAmtQ3);
                 element[25] = decode(obj.refundAmtQ3, '0.0','0',obj.refundAmtQ3);
                 ...
                 element[29] = decode(obj.rateOfReturnQ4, '0.0','0',obj.rateOfReturnQ4);
                 element[30] = decode(obj.collectAmtQ4, '0.0','0',obj.collectAmtQ4);
                 element[31] = decode(obj.rentFeeAmtQ4, '0.0','0',obj.rentFeeAmtQ4);
                 element[32] = decode(obj.refundAmtQ4, '0.0','0',obj.refundAmtQ4);
	     ...
	     var summaryData;
	     var incomeTotal = 0, collectTotal = 0, refundTotal = 0;
	     function calculateSummary() {
	         
	         var footerSummary;
	         var totIncome = 0, totCollect = 0,totRefund = 0;
	         if (dataCnt > 0) {
	     ...
	     var obj = {title: "<b>Booth Incomes</b> List", resizable: true, freezeCols: 5,numberCell: false,  editable: false, flexHeight:true, selectionModel: { type: 'row' },scrollModel: { horizontal: true }};
	     obj.width = "98%";
	     obj.height = "350";
	
	     obj.colModel = [
	                     {title:'<b>Booth</b>',dataIndx: 0, width:200, dataType:"string",align: "left", sortable:false},
