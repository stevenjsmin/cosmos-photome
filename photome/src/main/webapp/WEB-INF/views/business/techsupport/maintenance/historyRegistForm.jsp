...
<script type="text/javascript">
    ...
    function saveHistoryInfo() {
        ...
        $.ajax({
            url : "/photome/business/techsupport/maintenance/HistoryRegist.action",
            data : {
            	claimType       : claimType    ,
		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0" >
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><br /> &nbsp;<textarea name="contents" id="contents" rows="10" cols="2" style="width: 500px; height: 150px;"  mandatory="true"></textarea> <br /> <br /></td>
                </tr>
