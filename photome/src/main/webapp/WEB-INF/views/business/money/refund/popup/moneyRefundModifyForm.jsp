            ...
            <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="value" colspan="3">
                        <input type="text" id="boothName" name="boothName" style="width: 350px; background-color: #E5E5E5;" readonly="readonly" mandatory="true" value="<c:out value="${refundDto.boothName }" />" />
                ...
                <tr>
                    ...
                    <td class="value"><input type="text" id="reqLastname" name="reqLastname" style="width: 150px;" maxlength="25" mandatory="true" value="<c:out value="${refundDto.reqLastname }" />" /></td>
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><input type="text" id="reqContactInfo" name="reqContactInfo" style="width: 380px;" mandatory="true"  value="<c:out value="${refundDto.reqContactInfo }" />" /></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
                ...
                <tr>
                    ...
                    <td class="value">
                        <input type="text" id="reqPostcd" name="reqPostcd" style="width: 100px;;background-color: #DFEFFF;" mandatory="true" onblur="setAddress(this);"  value="<c:out value="${refundDto.reqPostcd }" />" />
                    ...
                    <td class="value"><input type="text" id="reqState" name="reqState" style="width: 150px; background-color: #E5E5E5;" mandatory="true" readonly="readonly" value="<c:out value="${refundDto.reqState }" />" /></td>
                </tr>
                <tr>
                    <td class="label"><span class="required">*</span>No/Street :</td>
                    <td class="value" colspan="3"><input type="text" id="reqStreetNo" name="reqStreetNo" style="width: 380px;" mandatory="true" value="<c:out value="${refundDto.reqStreetNo }" />" /></td>
                </tr>
                <tr>
                    <td class="label"><span class="required">*</span>Suburb :</td>
                    <td class="value" colspan="3">
                        <select name="reqSuburb" id="reqSuburb" style="width: 150px" mandatory="true">
