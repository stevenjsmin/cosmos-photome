...
<script type="text/javascript">
    function loadPage() {
    	$('#bankName > option[value=\'<c:out value="${bankAcctInfoDto.bankName}"/>\']').attr("selected", "true");
    }
</script>
<script type="text/javascript">
    function save() {
        ...
        $.ajax({
                url : "/photome/business/resmanage/bankAccount/BankAccountInfoUpdate.action",
                data : {
                	acctId : acctId,
                    bankName : bankName,
                    acctName : acctName,
    ...
    function callbackSave(data) {
    	pageLog("New Information modified");

        var returnValue = {
            message : $('#bankName').val()
        };
        ...
        <div id="detail_panel" class="detail_panel">
            <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="value"><input type="text" id="acctName" name="acctName" style="width: 300px;" mandatory="true" value="<c:out value="${bankAcctInfoDto.acctName}" />" /></td>
                </tr>
                <tr>
                    <td class="label"><span class="required">*</span>BSB no. :</td>
                    <td class="value"><input type="text" id="bankBsb" name="bankBsb" style="width: 150px;" mandatory="true" maxlength="6" value="<c:out value="${bankAcctInfoDto.bankBsb}" />" /></td>
                </tr>
                <tr>
                    <td class="label"><span class="required">*</span>Account No. :</td>
                    <td class="value"><input type="text" id="bankAcctNo" name="bankAcctNo" style="width: 300px;" mandatory="true" value="<c:out value="${bankAcctInfoDto.bankAcctNo}" />" /></td>
                </tr>
                <tr>
                    <td class="label"><span class="required">*</span>Account Holder Name :</td>
                    <td class="value"><input type="text" id="bankAcctHolderName" name="bankAcctHolderName" style="width: 300px;" mandatory="true" value="<c:out value="${bankAcctInfoDto.bankAcctHolderName}" />" /></td>
                </tr>
